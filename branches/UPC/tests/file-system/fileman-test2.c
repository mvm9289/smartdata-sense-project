...
#define NUM_SECONDS_WRITE 2
#define STATE_INIT 0
#define STATE_WRITE 1
#define STATE_READ 2
#define SEEK_POSITION -1
    ...
    while (1)
    {
        ...
        if (ev == PROCESS_EVENT_TIMER)
        {
          ...
          else if (state == STATE_READ)
          {
            ...
            if (read_bytes == 0) readSeek(SEEK_POSITION);
          
            if (write_number < MAX_SAMPLE_NUMBER) state = STATE_WRITE;
          }
