                         ...
                         uint8_t hops    )
{
    ...
    if (packetbuf_datalen() >= PACKET_SIZE)
    {
		...
		printf("%d %c %d %d // %d %c %d %d // ", recv_packet.data[0], recv_packet.data[1], *(int *)(&recv_packet.data[2]),  *(int *)(&recv_packet.data[4]), 
		recv_packet.data[6], recv_packet.data[7], *(int *)(&recv_packet.data[8]),  *(int *)(&recv_packet.data[10]));
